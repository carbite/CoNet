...
class CoNet_6000_4000_2000(nn.Module):
    def __init__(self, in_size, out_size, d_size, hidden_d1_size, hidden_d2_size, hidden_d3_size, dropout_rate_AE):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(hidden_d1_size, hidden_d2_size),
            nn.Dropout(dropout_rate_AE),
            nn.ReLU(),
            nn.Linear(hidden_d2_size, hidden_d3_size),
            nn.Dropout(dropout_rate_AE),
            nn.ReLU(),
            nn.Linear(hidden_d3_size, d_size),
        )
        self.decoder = nn.Sequential(
            nn.Linear(d_size, hidden_d3_size),
            nn.Dropout(dropout_rate_AE),
            nn.ReLU(),
            nn.Linear(hidden_d3_size, hidden_d2_size),
            nn.Dropout(dropout_rate_AE),
            nn.ReLU(),
            nn.Linear(hidden_d2_size, hidden_d1_size),
            nn.Dropout(dropout_rate_AE),
            nn.ReLU(),
